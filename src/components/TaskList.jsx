          ...
          <div className="task-buttons">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-trash" viewBox="0 0 16 16">
                ...
                <path fillRule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h3.5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1H13a1 1 0 0 1 1 1v1zM4.118 4 4 4h8l-.118-.118H4.118zM5 4v9a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1V4H5z"/>
              </svg>
            </button>
          </div>
        </li>
